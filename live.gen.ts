...
import * as $3 from "./functions/butterCMSPage.ts";
import * as $4 from "./functions/vtexProductDetailsPage.ts";
import * as $5 from "./functions/butterCMSFeaturedPosts.ts";
import * as $6 from "./functions/occProductDetailsPage.ts";
import * as $7 from "./functions/vtexProductListingPage.ts";
import * as $8 from "./functions/shopifyProductDetailsPage.ts";
import * as $9 from "./functions/butterCMSAds.ts";
import * as $10 from "./functions/butterCMSPosts.ts";
import * as $11 from "./functions/vtexWishlist.ts";
import * as $12 from "./functions/vndaProductList.ts";
...
import * as $17 from "./functions/butterCMSPostDetail.ts";
import * as $18 from "./functions/vtexNavbar.ts";
import * as $19 from "./functions/butterCMSCategories.ts";
import * as $20 from "./functions/vtexLegacyProductList.ts";
import * as $21 from "./functions/requestToParam.ts";
import * as $22 from "./functions/butterCMSPlaces.ts";
import * as $23 from "./functions/vndaProductListingPage.ts";
import * as $24 from "./functions/vtexLegacyProductDetailsPage.ts";
...
import * as $$4 from "./accounts/butterCMS.ts";
...
import * as $$$2 from "./loaders/x/redirects.ts";
import * as $$$3 from "./loaders/x/redirectsFromCsv.ts";
...
import * as $$$13 from "./loaders/vtex/intelligentSearch/productListingPage.ts";
import * as $$$14 from "./loaders/vtex/intelligentSearch/suggestions.ts";
import * as $$$15 from "./loaders/vtex/intelligentSearch/productList.ts";
import * as $$$16 from "./loaders/vtex/intelligentSearch/productDetailsPage.ts";
import * as $$$17 from "./loaders/vtex/segment.ts";
import * as $$$18 from "./loaders/vtex/user.ts";
import * as $$$19 from "./loaders/vnda/proxy.ts";
import * as $$$20 from "./loaders/vnda/productListingPage.ts";
import * as $$$21 from "./loaders/vnda/cart.ts";
import * as $$$22 from "./loaders/vnda/productList.ts";
import * as $$$23 from "./loaders/vnda/productDetailsPage.ts";
import * as $$$24 from "./loaders/linxImpulse/autocompletes/suggestions.ts";
import * as $$$25 from "./loaders/linxImpulse/autocompletes/popular.ts";
import * as $$$26 from "./loaders/linxImpulse/search.ts";
import * as $$$27 from "./loaders/linxImpulse/pages/recommendations.ts";
import * as $$$28 from "./loaders/linxImpulse/products/similarItems.ts";
import * as $$$29 from "./loaders/nuvemShop/nuvemShopProductListingPage.ts";
import * as $$$30 from "./loaders/nuvemShop/nuvemShopProductList.ts";
import * as $$$31 from "./loaders/nuvemShop/nuvemShopProductDetailsPage.ts";
...
import * as $$$$$$$$1 from "./sections/configNuvemShop.tsx";
...
import * as $$$$$$$$8 from "./sections/SEOPLP.tsx";
import * as $$$$$$$$9 from "./sections/configButterCMS.global.tsx";
import * as $$$$$$$$10 from "./sections/VTEXPortalDataLayerCompatibility.tsx";
import * as $$$$$$$$11 from "./sections/Analytics.tsx";
import * as $$$$$$$$$$$0 from "./actions/vtex/notifyme.ts";
import * as $$$$$$$$$$$1 from "./actions/vtex/cart/updateAttachment.ts";
import * as $$$$$$$$$$$2 from "./actions/vtex/cart/updateItemAttachment.ts";
import * as $$$$$$$$$$$3 from "./actions/vtex/cart/simulation.ts";
import * as $$$$$$$$$$$4 from "./actions/vtex/cart/updateItems.ts";
import * as $$$$$$$$$$$5 from "./actions/vtex/cart/updateCoupons.ts";
import * as $$$$$$$$$$$6 from "./actions/vtex/cart/addItems.ts";
import * as $$$$$$$$$$$7 from "./actions/vtex/cart/updateItemPrice.ts";
import * as $$$$$$$$$$$8 from "./actions/vtex/cart/updateUser.ts";
...
import * as $$$$$$$$$$$12 from "./actions/vtex/cart/removeItems.ts";
...
import * as $$$$$$$$$$$17 from "./actions/vnda/cart/addItem.ts";
import * as $$$$$$$$$$$18 from "./actions/vnda/cart/updateCoupon.ts";
import * as $$$$$$$$$$$19 from "./actions/vnda/cart/setShippingAddress.ts";
import * as $$$$$$$$$$$20 from "./actions/vnda/cart/updateItem.ts";
...
const manifest = {
  "functions": {
    "deco-sites/std/functions/butterCMSAds.ts": $9,
    "deco-sites/std/functions/butterCMSBrands.ts": $16,
    "deco-sites/std/functions/butterCMSCategories.ts": $19,
    "deco-sites/std/functions/butterCMSFeaturedPosts.ts": $5,
    "deco-sites/std/functions/butterCMSPage.ts": $3,
    "deco-sites/std/functions/butterCMSPlaces.ts": $22,
    "deco-sites/std/functions/butterCMSPostDetail.ts": $17,
    "deco-sites/std/functions/butterCMSPosts.ts": $10,
    "deco-sites/std/functions/butterCMSRelatedPosts.ts": $0,
    "deco-sites/std/functions/occProductDetailsPage.ts": $6,
    "deco-sites/std/functions/requestToParam.ts": $21,
    ...
    "deco-sites/std/functions/vndaProductList.ts": $12,
    "deco-sites/std/functions/vndaProductListingPage.ts": $23,
    "deco-sites/std/functions/vtexLegacyProductDetailsPage.ts": $24,
    ...
    "deco-sites/std/functions/vtexProductDetailsPage.ts": $4,
  ...
  "accounts": {
    "deco-sites/std/accounts/butterCMS.ts": $$4,
  ...
  "loaders": {
    ...
    "deco-sites/std/loaders/linxImpulse/autocompletes/popular.ts": $$$25,
    "deco-sites/std/loaders/linxImpulse/autocompletes/suggestions.ts": $$$24,
    "deco-sites/std/loaders/linxImpulse/pages/recommendations.ts": $$$27,
    "deco-sites/std/loaders/linxImpulse/products/similarItems.ts": $$$28,
    "deco-sites/std/loaders/linxImpulse/search.ts": $$$26,
    "deco-sites/std/loaders/nuvemShop/nuvemShopProductDetailsPage.ts": $$$31,
    "deco-sites/std/loaders/nuvemShop/nuvemShopProductList.ts": $$$30,
    "deco-sites/std/loaders/nuvemShop/nuvemShopProductListingPage.ts": $$$29,
    "deco-sites/std/loaders/vnda/cart.ts": $$$21,
    "deco-sites/std/loaders/vnda/productDetailsPage.ts": $$$23,
    "deco-sites/std/loaders/vnda/productList.ts": $$$22,
    "deco-sites/std/loaders/vnda/productListingPage.ts": $$$20,
    "deco-sites/std/loaders/vnda/proxy.ts": $$$19,
    ...
    "deco-sites/std/loaders/vtex/intelligentSearch/productListingPage.ts":
      $$$13,
    "deco-sites/std/loaders/vtex/intelligentSearch/suggestions.ts": $$$14,
    ...
    "deco-sites/std/loaders/vtex/segment.ts": $$$17,
    ...
    "deco-sites/std/loaders/x/redirects.ts": $$$2,
    "deco-sites/std/loaders/x/redirectsFromCsv.ts": $$$3,
  },
  "routes": {
    "./routes/_app.tsx": $$$$0,
    "./routes/404.tsx": $$$$2,
  ...
  "sections": {
    ...
    "deco-sites/std/sections/SEO.tsx": $$$$$$$$6,
    "deco-sites/std/sections/SEOPDP.tsx": $$$$$$$$0,
    "deco-sites/std/sections/SEOPLP.tsx": $$$$$$$$8,
  ...
  "actions": {
    ...
    "deco-sites/std/actions/vnda/cart/addItem.ts": $$$$$$$$$$$17,
    "deco-sites/std/actions/vnda/cart/setShippingAddress.ts": $$$$$$$$$$$19,
    "deco-sites/std/actions/vnda/cart/updateCoupon.ts": $$$$$$$$$$$18,
    "deco-sites/std/actions/vnda/cart/updateItem.ts": $$$$$$$$$$$20,
    ...
    "deco-sites/std/actions/vtex/cart/removeItems.ts": $$$$$$$$$$$12,
    "deco-sites/std/actions/vtex/cart/simulation.ts": $$$$$$$$$$$3,
    "deco-sites/std/actions/vtex/cart/updateAttachment.ts": $$$$$$$$$$$1,
    "deco-sites/std/actions/vtex/cart/updateCoupons.ts": $$$$$$$$$$$5,
    "deco-sites/std/actions/vtex/cart/updateItemAttachment.ts": $$$$$$$$$$$2,
    "deco-sites/std/actions/vtex/cart/updateItemPrice.ts": $$$$$$$$$$$7,
    "deco-sites/std/actions/vtex/cart/updateItems.ts": $$$$$$$$$$$4,
    "deco-sites/std/actions/vtex/cart/updateProfile.ts": $$$$$$$$$$$11,
    "deco-sites/std/actions/vtex/cart/updateUser.ts": $$$$$$$$$$$8,
